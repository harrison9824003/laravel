...
@section('content')
    <div class="d-flex flex-column h-100 bg-white p-3 rounded">
        <div class="d-flex mb-5">
            <a href="{{ route('category.create') }}" class="btn btn-icon btn-primary d-flex">
                        ...
                        <td class="text-end">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('category.edit', ['category' => $category->id]) }}"><i class="bx bx-edit-alt me-1"></i> 編輯</a>
                                    <a class="dropdown-item" href="javascript:void(0);" id="{{ $category->id }}" onclick="deleteCtegory(this.id)"><i class="bx bx-trash me-1"></i> 刪除</a>
                                </div>
                            </div>
                        </td>
                    </tr>
