<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <a href="{{ route('admin.index') }}" class="app-brand-link">
        ...
        <span class="app-brand-text demo menu-text fw-bolder ms-2">管理後台</span>
    </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <div data-i18n="Account Settings">商品</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <div data-i18n="Notifications">商品列表</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    ...
                    <div data-i18n="Account">文章分類</div>
                    </a>
                </li>   
                <li class="menu-item">
                    <a href="{{ route('article.index') }}" class="menu-link">
                    <div data-i18n="Account">文章列表</div>
                    </a>
                </li>     
            </ul>
        </li>
